...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/font-awesome.min.css')}}">

    <!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/smartadmin-production.min.css')}}">
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/smartadmin-skins.min.css')}}">

    <!-- SmartAdmin RTL Support is under construction-->
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/smartadmin-rtl.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/your_style.css')}}">

    <!-- Demo purpose only: goes with demo.js, you can delete this css when designing your own WebApp -->
    <link rel="stylesheet" type="text/css" media="screen" href="{{url('backend/smartadmin/css/demo.min.css')}}">

    <!-- FAVICONS -->
    <link rel="shortcut icon" href="{{url('backend/smartadmin/img/favicon/favicon.ico')}}" type="image/x-icon">
    <link rel="icon" href="{{url('backend/smartadmin/img/favicon/favicon.ico')}}" type="image/x-icon">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-lg-offset-4">
                <div class="well no-padding">
                    {{ Form::open(array('url' => 'login','class'=>'smart-form client-form')) }}
                        <header>
                            Sign In
                        </header>
